/*
 * 실습문제 8-1. if-else문을 이용하여 프로그램을 작성하라.
...
public class Practice08_1 {
	public static void main(String[] args) {
		...
		if(operation.equals("더하기") == true) {
			answer = number1 + number2;
		}
		else if(operation.equals("빼기") == true) {
			answer = number1 - number2;
		}
		else if(operation.equals("곱하기") == true) {
			answer = number1 * number2;
		}
		else if(operation.equals("나누기") == true) {
		...
		else if(operation.equals("더하기") == false && operation.equals("빼기") == false && operation.equals("곱하기") == false && operation.equals("나누기") == false) {
